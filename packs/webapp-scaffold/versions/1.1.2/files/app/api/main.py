...
def create_app(db_path: Optional[str] = None) -> FastAPI:
    ...
    async def health():
        ...
        migration = {
            ...
            "content_mismatches": [],
            "ledger_ahead": [],
            "adoption_receipt_guards_ready": False,
            "missing_adoption_receipt_guards": [],
        }
        try:
        ...
        migration_ready = (
            migration["ready"] and migration["content_identity_ready"]
        )
        healthy = db_ok and migration_ready
        payload = {
            ...
            "data": {
                ...
                "migrations_current": (
                    ...
                    and migration["content_identity_ready"]
                    and migration["adoption_receipt_guards_ready"]
                ),
                "migration_ready": migration_ready,
                "pending_migrations": migration["pending"],
                "migration_content_matches": migration["content_matches"],
                "migration_content_adoption_required": migration[
                    "adoption_required"
                ],
                "migration_content_mismatches": migration["content_mismatches"],
                "migration_ledger_ahead": migration["ledger_ahead"],
                "migration_adoption_receipt_guards_ready": migration[
                    "adoption_receipt_guards_ready"
                ],
                "missing_migration_adoption_receipt_guards": migration[
                    "missing_adoption_receipt_guards"
                ],
