...
def test_existing_legacy_database_adopts_from_exact_manifest(
    ...
    payload = {
        ...
        "entries": [
            {
                "name": entry.name,
                "content_sha256": migration_runner.module_sha256(entry),
            }
        ],
    }
    ...
    result = migration_runner.migrate(
        ...
        source_commit=source_commit, adopted_by="test-operator",
        source_sha256="a" * 64, manifest_sha256=manifest_sha256,
    )
