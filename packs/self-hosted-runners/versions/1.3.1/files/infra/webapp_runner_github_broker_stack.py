...
def _lambda_code() -> pulumi.AssetArchive:
    ...
    return pulumi.AssetArchive(
        {
            "index.mjs": pulumi.StringAsset((root / "webapp_runner_github_broker.mjs").read_text()),
            "webapp_runner_aws_state.mjs": pulumi.StringAsset((root / "webapp_runner_aws_state.mjs").read_text()),
            "webapp_runner_github_api.mjs": pulumi.StringAsset((root / "webapp_runner_github_api.mjs").read_text()),
            "webapp_runner_registration.mjs": pulumi.StringAsset((root / "webapp_runner_registration.mjs").read_text()),
            "webapp_runner_termination.mjs": pulumi.StringAsset((root / "webapp_runner_termination.mjs").read_text()),
            "webapp_runner_parallel_reaper.mjs": pulumi.StringAsset((root / "webapp_runner_parallel_reaper.mjs").read_text()),
        }
    )
...
def create_runner_github_broker(
    ...
    *,
    ...
    bootstrap_parent_arn = (
        f"arn:aws:ssm:{region}:{account_id}:parameter{bootstrap_prefix}"
    )
