...
PROJECT_HEALTH_CHECKS = self_project_checks(
    ('apply-patch-deny-smoke', 'apply_patch deny smoke still passes offline', hc_apply_patch_deny_smoke),
    ('apply-patch-observe-smoke', 'apply_patch events recorded with changed paths', hc_apply_patch_observe_smoke),
)
