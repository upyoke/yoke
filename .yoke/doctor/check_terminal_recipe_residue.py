...
* ``.yoke/docs/reference/db-reference/**`` — operator CLI reference with sanctioned adapter
  examples.
...
def hc_terminal_recipe_residue(
    ...
    if findings:
        rec.record(
            ...
            "docs/archive/**, .yoke/docs/reference/db-reference/**, and "
...
PROJECT_HEALTH_CHECKS = self_project_checks(
    ('terminal-recipe-residue', 'Retired terminal-soup recipes in live guidance', hc_terminal_recipe_residue),
)
