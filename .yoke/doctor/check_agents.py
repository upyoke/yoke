...
single ``from yoke_project_checks.check_agents import (...)``.
...
from yoke_project_checks.check_agents_hooks import (  # noqa: F401
...
from yoke_project_checks.check_agents_prompts import (  # noqa: F401
...
PROJECT_HEALTH_CHECKS = self_project_checks(
    ('agent-consistency', 'Agent prompt consistency', hc_agent_consistency),
    ('agent-canonical-drift', 'Claude adapter canonical drift', hc_agent_canonical_drift),
    ('browser-substrate', 'Browser substrate health', hc_browser_substrate),
)
