...
PROJECT_HEALTH_CHECKS = self_project_checks(
    ('prompt-command-consistency', 'Prompt/docs advertise supported CLI syntax', hc_prompt_command_consistency),
    ('prompt-doctrine-consistency', 'Canonical giant doctrine + short-form consistency', hc_prompt_doctrine_consistency),
)
