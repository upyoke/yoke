...
PROJECT_HEALTH_CHECKS = self_project_checks(
    ('hook-executability', 'Hook script executability', hc_hook_executability),
    ('self-test', 'Self-test', hc_self_test),
    ('session-startup-hook', 'Session startup hook', hc_session_startup_hook),
)
