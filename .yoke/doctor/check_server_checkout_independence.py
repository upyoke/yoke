...
PROJECT_HEALTH_CHECKS = self_project_checks(
    ('server-checkout-independence', 'Server-reachable code must not resolve a repo root from ambient context (find_repo_root / cwd / git rev-parse)', hc_server_checkout_independence),
)
