...
PROJECT_HEALTH_CHECKS = self_project_checks(
    ('codex-hook-matchers', 'Codex hooks.json matchers cover required event/tool combos', hc_codex_hook_matchers),
    ('codex-hook-floor', 'Operator Codex CLI meets manifest hook_enhanced floor', hc_codex_hook_floor),
    ('codex-hook-doc-drift', 'Codex hook docs describe the current matcher set', hc_codex_hook_doc_drift),
)
