...
requirement_selection TEXT -- member requirement/plan IDs selected for admission
requirement_selection_source TEXT -- derived | explicit; a derived selection is recomputed at composition freeze
