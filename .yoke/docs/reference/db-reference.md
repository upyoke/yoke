...
- [steering-fleet-report.md](db-reference/steering-fleet-report.md) — what the steering seat cannot see from inside its own turn: available work, quiet holders, starved delivery, unregistered launches, items landed without close-out, and dead waits.
