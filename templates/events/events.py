...
(Section D, Template 2). This module is a reference implementation intended
to be copied into each project that needs backend event emission.
...
templates/events/README.md for details.
