...
Follow [ARTIFACT-REFRESH.md](ARTIFACT-REFRESH.md) to preview, apply, verify, or
adopt existing template-rendered deployment artifacts. That contract keeps
project-owned runbooks separate and preserves local deviations.
...
See [Project Stacks and Environment Instances](PROJECT-STACKS.md) for the
generated stack layout, per-environment settings, and deploy-time bindings.
