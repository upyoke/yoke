# AUTO-GENERATED template source: templates/webapp/infra/webapp_distribution_github_variables.py. Do not hand-edit rendered copies; refresh through Yoke template/onboarding surfaces.
