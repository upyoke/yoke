# AUTO-GENERATED template source: templates/webapp/infra/webapp_runner_host_cycle.py. Do not hand-edit rendered copies; refresh through Yoke template/onboarding surfaces.
