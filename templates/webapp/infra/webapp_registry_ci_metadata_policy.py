# AUTO-GENERATED template source: templates/webapp/infra/webapp_registry_ci_metadata_policy.py. Do not hand-edit rendered copies; refresh through Yoke template/onboarding surfaces.
