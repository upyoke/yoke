...
member's scoped QA passes or is waived, completion-flow success closes the item
automatically and ends an otherwise empty holder session; the worker re-parks
after an acceptance wake instead of rerunning merge solely for that acceptance.
