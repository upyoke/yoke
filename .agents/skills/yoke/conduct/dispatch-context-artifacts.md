...
yoke qa run add --requirement-id {req-id} --performed-by "agent" --qa-kind "ac_verification" --verdict "pass" --head-sha <commit> --raw-result "Brief evidence"
