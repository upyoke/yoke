...
ACTIONS_VARIABLES_PERMISSION = "actions_variables"
...
GITHUB_REPOSITORY_HOOKS_WRITE_PERMISSION_LEVELS = _permission_levels(
...
REQUIRED_GITHUB_APP_REPOSITORY_PERMISSIONS = (
    ...
    GitHubAppRepositoryPermission(
        ACTIONS_VARIABLES_PERMISSION, "Variables", ACCESS_WRITE,
    ),
