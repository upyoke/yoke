...
* The field-note category prefix (``CATEGORY_PREFIX``), closed ``--kind``
  enum (``KIND_VALUES``), evidence length contract (``EVIDENCE_MAX_CHARS``),
  and the operator-facing definition of the ``observation`` kind
...
CATEGORY_PREFIX: str = "field-note-"
