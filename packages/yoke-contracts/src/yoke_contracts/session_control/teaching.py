...
FLEET_STEERING_ADDRESSING_GUIDANCE = (
    ...
    "releasing a claim you still hold; one terminal report per session and "
    "named item reaches the seat once, so a reworded retry is "
    "deduplicated rather than delivered twice. Ending a turn sends "
