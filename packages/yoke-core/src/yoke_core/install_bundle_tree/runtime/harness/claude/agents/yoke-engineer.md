...
- **`project_github_repo_bindings`** — `project_id, installation_id, repository_id, api_url, github_repo, default_branch, status, permissions, last_verified_at, last_error, created_at, updated_at, last_sync_at, last_sync_outcome, last_sync_error`
