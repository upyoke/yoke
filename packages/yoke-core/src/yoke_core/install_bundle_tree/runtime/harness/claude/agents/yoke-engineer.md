...
- **`deployment_runs`** — `id, project_id, flow, target_tier, target_environment_id, release_lineage, status, current_stage, created_at, started_at, completed_at, created_by, carried_work, bound_sources, artifact_identity, composition_resolution, composition_frozen_at, requirement_snapshot, driver_attachment`
