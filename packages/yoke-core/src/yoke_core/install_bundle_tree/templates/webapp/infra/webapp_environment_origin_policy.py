# AUTO-GENERATED template source: templates/webapp/infra/webapp_environment_origin_policy.py. Do not hand-edit rendered copies; refresh through Yoke template/onboarding surfaces.
