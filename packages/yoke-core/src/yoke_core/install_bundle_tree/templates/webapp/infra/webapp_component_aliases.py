# AUTO-GENERATED template source: templates/webapp/infra/webapp_component_aliases.py. Do not hand-edit rendered copies; refresh through Yoke template/onboarding surfaces.
