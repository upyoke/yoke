...
cannot be mapped to its permanent filename, a shipped applied entry declares
a floor that its ledger row does not record, or this build is below a recorded
