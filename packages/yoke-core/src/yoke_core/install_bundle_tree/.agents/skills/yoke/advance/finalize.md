...
- **Test command:** {_cmd_full or "uv run --frozen python3 -m yoke_core.tools.watch_pytest --impacted main" (yoke default — impacted selection; CI on the merge path owns the full sweep, see docs/testing-verification.md)}
