...
- **Pull forward / consume existing primitive:** Name the existing or current-slice primitive (`path_claims`, coordination claims, events ledger, actors, phase runs, execution journal, compiled packet, etc.) and make the work item consume it.
