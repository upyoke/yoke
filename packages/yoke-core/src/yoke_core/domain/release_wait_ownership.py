...
RELEASE_WAIT_RETENTION_TEACHING = (
    ...
    "deployment wake re-enters you when your delivery clears, when your own "
    "item-scoped QA is accepted, or when a QA stage needs you. A recorded "
    "`post_deploy_no_obligation` is closed by that same close-out when the "
    "completion-flow run succeeds, without a wake. A stage that "
