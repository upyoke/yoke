...
PROJECT_TABLES: dict[str, dict] = {
    ...
    "project_capabilities": {
        ...
        "notes": (
            ...
            "explicit standalone Pulumi stack references; the renderer "
            "merges and deduplicates them before resolving each stack's "
            "`originElasticIpAddress`, never a configured literal address. "
            "Resolve the project slug to `projects.id`, then "
