...
def register(registry) -> None:
    ...
    registry.register(
        ...
        _qa_post_deploy_declare_none.handle_qa_post_deploy_declare_none,
        _qa_post_deploy_declare_none.QaPostDeployDeclareNoneRequest,
        _qa_post_deploy_declare_none.QaPostDeployDeclareNoneResponse,
        stability="stable",
        owner_module="yoke_core.domain.handlers.qa_post_deploy_declare_none",
        target_kinds=["item"],
        side_effects=["qa_requirements_insert", "qa_requirements_update"],
        emitted_event_names=[
            "YokeFunctionCalled",
    ...
    registry.register(
        ...
        _qa_post_deploy_record_no_obligation.handle_qa_post_deploy_record_no_obligation,
        _qa_post_deploy_record_no_obligation.QaPostDeployRecordNoObligationRequest,
        _qa_post_deploy_record_no_obligation.QaPostDeployRecordNoObligationResponse,
        stability="stable",
        owner_module="yoke_core.domain.handlers.qa_post_deploy_record_no_obligation",
        target_kinds=["item"],
