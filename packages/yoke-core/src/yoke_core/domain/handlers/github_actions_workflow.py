...
class WorkflowFindRunResponse(BaseModel):
    ...
    #: A caller that must also work against a control plane serving from
    #: before this field existed reads its absence as "unavailable, not
    #: false" and degrades rather than treating it as a hard failure.
