...
def register(registry) -> None:
    ...
    registry.register(
        "qa.requirement.get",
        _qa_reads.handle_qa_requirement_get,
    ...
    registry.register(
        "qa.run.list",
        _qa_reads.handle_qa_run_list,
        _qa_reads.QaRunListRequest,
        _qa_reads.QaRunListResponse,
        stability="stable",
        owner_module="yoke_core.domain.handlers.qa_reads",
        target_kinds=["qa_requirement", "global"],
        side_effects=[],
        emitted_event_names=["YokeFunctionCalled"],
        guardrails=[],
        adapter_status="live",
    ...
    registry.register(
        "qa.run.get",
        _qa_reads.handle_qa_run_get,
        _qa_reads.QaRunGetRequest,
        _qa_reads.QaRunGetResponse,
        stability="stable",
        owner_module="yoke_core.domain.handlers.qa_reads",
        target_kinds=["global"],
        side_effects=[],
    ...
    registry.register(
        "qa.gate_summary.run",
        _qa_reads.handle_qa_gate_summary,
        _qa_reads.QaGateSummaryRequest,
        _qa_reads.QaGateSummaryResponse,
        stability="stable",
        owner_module="yoke_core.domain.handlers.qa_reads",
        target_kinds=["item", "epic_task"],
        side_effects=[],
        emitted_event_names=["YokeFunctionCalled"],
        guardrails=[],
        adapter_status="live",
    ...
    registry.register(
        "qa.requirement.add",
        _qa_create.handle_qa_requirement_add,
