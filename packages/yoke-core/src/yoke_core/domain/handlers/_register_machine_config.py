...
def _register_writers(registry) -> None:
    writers = (
        ...
        ("connection.remove.run", machine_config_write.handle_connection_remove,
         machine_config_write.ConnectionRemoveRequest,
         machine_config_write.ConnectionRemoveResponse),
