...
CLAIMS_COMMANDS: list[dict] = [
    ...
    },
    {
        ...
        "notes": (
            ...
            "failure. A `DONE PREFIX-N` heading names the reported item; it "
            "must be work this session holds or released, and that item "
            "addresses the seat. Send it before releasing a still-held claim; "
            "one report per session and named item reaches the seat once even "
            "when a reworded retry follows. Every worker reaches the "
