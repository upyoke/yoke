...
CLAIMS_COMMANDS: list[dict] = [
    ...
    },
    {
        ...
        "notes": (
            ...
            "--project P [--doc SLUG] [--reason TEXT]`. Acquire atomically "
            "pairs the seat with that document (default `CURRENT-PLAN`) and "
            "leaves neither claim behind when either is held elsewhere. "
            "Inspect with `yoke "
