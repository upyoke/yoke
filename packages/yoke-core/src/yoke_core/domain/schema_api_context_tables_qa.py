...
QA_TABLES: dict[str, dict] = {
    ...
    "qa_artifacts": {
        ...
        "notes": (
            ...
            "exclusive. Add stores under the requirement's item or "
            "deployment-run owner using the same local-handle construction "
            "and scratch tree that qa.artifact.read already serves, bounded "
            "by the reader inline limit (MAX_INLINE_BYTES, 20MiB). CLI: "
