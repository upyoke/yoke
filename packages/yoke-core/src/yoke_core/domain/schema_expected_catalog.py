...
_EXPECTED_SCHEMA_STR = (
    ...
    "|deployment_run_items:run_id/TEXT,item_id/INTEGER,added_at/TEXT,delivery_intent/TEXT,requirement_selection/TEXT,requirement_selection_source/TEXT,requirement_snapshot/TEXT,containment_attestation/TEXT"
