...
_EXPECTED_SCHEMA_STR = (
    ...
    "|merge_queue_landing_records:item_id/INTEGER,project_id/INTEGER,pr_number/TEXT,state/TEXT,head_sha/TEXT,failed_checks/TEXT,narrative/TEXT,disarm_note/TEXT,observed_at/TEXT,changed_at/TEXT"
