...
_EXPECTED_SCHEMA_STR = (
    ...
    "|deployment_runs:id/TEXT,project_id/INTEGER,flow/TEXT,target_tier/TEXT,target_environment_id/INTEGER,release_lineage/TEXT,status/TEXT,current_stage/TEXT,created_at/TEXT,started_at/TEXT,completed_at/TEXT,created_by/TEXT,carried_work/TEXT,bound_sources/TEXT,artifact_identity/TEXT,composition_resolution/TEXT,composition_frozen_at/TEXT,requirement_snapshot/TEXT"
