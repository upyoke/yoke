...
_EXPECTED_SCHEMA_STR = (
    ...
    "|actors:id/INTEGER,kind/TEXT,system_component/TEXT,name/TEXT,status/TEXT,created_at/TEXT"
    ...
    "|api_tokens:id/INTEGER,token_hash/TEXT,actor_id/INTEGER,machine_id/TEXT,name/TEXT,status/TEXT,created_at/TEXT,revoked_at/TEXT,expires_at/TEXT,last_used_at/TEXT,diagnostic_metadata/TEXT"
    ...
    "|deployment_runs:id/TEXT,project_id/INTEGER,flow/TEXT,target_tier/TEXT,target_environment_id/INTEGER,release_lineage/TEXT,status/TEXT,current_stage/TEXT,created_at/TEXT,started_at/TEXT,completed_at/TEXT,created_by/TEXT,carried_work/TEXT,bound_sources/TEXT,candidate_containment/TEXT,artifact_identity/TEXT,composition_resolution/TEXT,composition_frozen_at/TEXT,requirement_snapshot/TEXT,driver_attachment/TEXT,settling_at/TEXT"
    ...
    "|harness_machine_reports:project_id/INTEGER,machine_id/TEXT,harness_id/TEXT,glue_written/INTEGER,glue_present/INTEGER,glue_malformed/INTEGER,config_present/INTEGER,project_entry_present/INTEGER,approval_state/TEXT,unattended_posture/TEXT,reported_at/TEXT"
    "|harness_sessions:session_id/TEXT,executor/TEXT,executor_surface/TEXT,presentation_surface/TEXT,presentation_state/TEXT,presentation_mode/TEXT,presentation_source/TEXT,presentation_observed_at/TEXT,executor_version/TEXT,machine_id/TEXT,provider/TEXT,model/TEXT,requested_model/TEXT,requested_reasoning_effort/TEXT,requested_context_window_tokens/INTEGER,reasoning_effort/TEXT,context_window_tokens/INTEGER,usage_totals/TEXT,execution_lane/TEXT,workspace/TEXT,project_id/INTEGER,mode/TEXT,quiet_reason/TEXT,keepalive_until/TEXT,keepalive_reason/TEXT,offered_at/TEXT,last_heartbeat/TEXT,turn_posture/TEXT,turn_posture_at/TEXT,ended_at/TEXT,terminated_at/TEXT,terminated_by_actor_id/INTEGER,terminated_by_session_id/TEXT,termination_reason/TEXT,offer_envelope/TEXT,current_item_id/TEXT,current_item_set_at/TEXT,recent_item_id/TEXT,recent_item_status/TEXT,recent_item_recorded_at/TEXT,last_seen_main_sha/TEXT,last_drift_check_at/TEXT,last_tool_call_at/TEXT,tool_call_count/INTEGER,episode_started_at/TEXT,native_process_gone_at/TEXT,native_process_gone_evidence/TEXT,pending_resume_notice/TEXT,last_chain_step/INTEGER,last_checkpoint_at/TEXT,actor_id/INTEGER,native_thread_id/TEXT,last_steering_report_at/TEXT,last_steering_report_fingerprint/TEXT,first_user_prompt_at/TEXT,first_completed_work_at/TEXT,last_completed_work_at/TEXT,native_turn_end_recorded_at/TEXT,native_turn_end_observation/TEXT,vendor_resume_episode_key/TEXT,vendor_resume_attempts/INTEGER"
    ...
    "|item_landings:id/INTEGER,item_id/INTEGER,merge_sha/TEXT,candidate_sha/TEXT,pr_number/TEXT,target_branch/TEXT,route/TEXT,landed_at/TEXT,origin/TEXT"
    "|item_gate_satisfactions:id/INTEGER,item_id/INTEGER,obligation/TEXT,rung_id/TEXT,target_status/TEXT,detail/TEXT,facts/TEXT,recorded_at/TEXT,recorded_by_session_id/TEXT"
    ...
    "|merge_queue_landing_records:item_id/INTEGER,project_id/INTEGER,pr_number/TEXT,state/TEXT,head_sha/TEXT,queue_holding/TEXT,queue_entry_state/TEXT,merge_when_ready/TEXT,failed_checks/TEXT,narrative/TEXT,disarm_note/TEXT,observed_at/TEXT,changed_at/TEXT"
    "|merge_queue_landing_refreshes:project_id/INTEGER,started_at/TEXT,completed_at/TEXT,last_error/TEXT"
    ...
    "|model_reference_revisions:revision_id/TEXT,effective_at/TEXT,published_at/TEXT,published_by_actor_id/INTEGER,catalog_json/TEXT,source_note/TEXT,source_revision_id/TEXT"
    "|machines:machine_id/TEXT,name/TEXT,owner_actor_id/INTEGER,access/TEXT,registered_at/TEXT,last_seen_at/TEXT,retired_at/TEXT,retired_by_actor_id/INTEGER"
    ...
    "|project_derived_facts:id/INTEGER,project_id/INTEGER,fact_key/TEXT,present/INTEGER,fact_value/TEXT,observed_at/TEXT,observed_from/TEXT"
    ...
    "|qa_plan_executions:id/TEXT,item_id/INTEGER,deployment_run_id/TEXT,transition_id/TEXT,actor_id/TEXT,session_id/TEXT,roster_digest/TEXT,roster_json/TEXT,cursor_ordinal/INTEGER,state/TEXT,machine_lease_id/INTEGER,created_at/TEXT,heartbeat_at/TEXT,completed_at/TEXT,release_reason/TEXT,execution_target_json/TEXT,execution_target_digest/TEXT,continues_execution_id/TEXT,deployment_stage/TEXT,deployment_member_item_id/INTEGER"
    "|qa_plan_item_attachments:item_id/INTEGER,transition_id/TEXT,qa_phase/TEXT,plan_id/INTEGER,attached_at/TEXT,attached_by_actor_id/INTEGER,retracted_at/TEXT,retraction_rationale/TEXT,retraction_source/TEXT,retracted_by_actor_id/INTEGER"
    ...
    "|session_ci_run_waits:id/INTEGER,session_id/TEXT,project_id/INTEGER,repo/TEXT,run_id/TEXT,head_sha/TEXT,kind/TEXT,continue_command/TEXT,created_at/TEXT,read_at/TEXT,conclusion/TEXT,notified_at/TEXT"
    "|session_evidence_fetches:fetch_id/TEXT,target_session_id/TEXT,project_id/INTEGER,machine_id/TEXT,kind/TEXT,file_name/TEXT,diagnostic_ref/TEXT,tail_lines/INTEGER,state/TEXT,requested_at/TEXT,requested_by_actor_id/INTEGER,requested_by_session_id/TEXT,lease_id/TEXT,lease_expires_at/TEXT,completed_at/TEXT,result_code/TEXT,files/TEXT,selected_file/TEXT,content/TEXT,content_bytes/INTEGER,truncated/INTEGER"
    ...
    "|session_message_recipients:message_id/TEXT,session_id/TEXT,project_id/INTEGER,resolution_evidence/TEXT,routing_snapshot/TEXT,executor_surface/TEXT,executor_version/TEXT,machine_id/TEXT,state/TEXT,created_at/TEXT,wake_after/TEXT,injection_lease_id/TEXT,injection_leased_at/TEXT,injection_lease_expires_at/TEXT,injection_count/INTEGER,last_injected_at/TEXT,acknowledged_at/TEXT,expired_at/TEXT,cancelled_at/TEXT,wake_attempt_count/INTEGER,last_wake_at/TEXT,wake_escalation/TEXT"
    "|session_messages:message_id/TEXT,sender_actor_id/INTEGER,sender_session_id/TEXT,body/TEXT,body_sha256/TEXT,selector_snapshot/TEXT,idempotency_key/TEXT,created_at/TEXT,expires_at/TEXT,cancelled_at/TEXT,cancelled_by_actor_id/INTEGER,cancellation_reason/TEXT,sender_surface/TEXT"
    "|session_relays:relay_id/TEXT,actor_id/INTEGER,machine_id/TEXT,hostname/TEXT,relay_version/TEXT,surface_versions/TEXT,surface_confirmed_absent/TEXT,project_checkouts/TEXT,first_seen_at/TEXT,last_seen_at/TEXT,connected_until/TEXT,last_job_at/TEXT,state/TEXT,lease_id/TEXT,lease_expires_at/TEXT,surface_plan_limits/TEXT,machine_capacity/TEXT,preferred_session_models/TEXT,relay_health/TEXT,preferred_session_reasoning_efforts/TEXT,surface_native_models/TEXT,credential_presence/TEXT"
    ...
    "|session_promised_work_holds:session_id/TEXT,item_id/INTEGER,hold_count/INTEGER,last_hold_at/TEXT"
    ...
    "|test_machine_operation_receipts:project_id/INTEGER,capability_type/TEXT,operation/TEXT,status/TEXT,performed_at/TEXT,receipt_json/TEXT,error_code/TEXT,lease_id/INTEGER,contract_digest/TEXT,updated_at/TEXT"
