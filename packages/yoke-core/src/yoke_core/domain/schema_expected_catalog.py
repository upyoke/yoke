...
_EXPECTED_SCHEMA_STR = (
    ...
    "|session_relays:relay_id/TEXT,machine_id/TEXT,relay_version/TEXT,surface_versions/TEXT,project_checkouts/TEXT,first_seen_at/TEXT,last_seen_at/TEXT,connected_until/TEXT,last_job_at/TEXT,state/TEXT,lease_id/TEXT,lease_expires_at/TEXT"
