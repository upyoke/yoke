...
_EXPECTED_SCHEMA_STR = (
    ...
    "|harness_sessions:session_id/TEXT,executor/TEXT,executor_surface/TEXT,executor_version/TEXT,machine_id/TEXT,provider/TEXT,model/TEXT,execution_lane/TEXT,workspace/TEXT,project_id/INTEGER,mode/TEXT,offered_at/TEXT,last_heartbeat/TEXT,turn_posture/TEXT,turn_posture_at/TEXT,ended_at/TEXT,offer_envelope/TEXT,current_item_id/TEXT,current_item_set_at/TEXT,recent_item_id/TEXT,recent_item_status/TEXT,recent_item_recorded_at/TEXT,last_seen_main_sha/TEXT,last_drift_check_at/TEXT,last_tool_call_at/TEXT,tool_call_count/INTEGER,episode_started_at/TEXT,pending_resume_notice/TEXT,last_chain_step/INTEGER,last_checkpoint_at/TEXT,actor_id/INTEGER"
    ...
    "|session_launch_attempts:attempt_id/TEXT,launch_id/TEXT,relay_id/TEXT,machine_id/TEXT,lease_id/TEXT,attempt_number/INTEGER,adapter_revision/TEXT,started_at/TEXT,completed_at/TEXT,native_session_id/TEXT,result_code/TEXT,evidence/TEXT"
    "|session_launches:launch_id/TEXT,requester_actor_id/INTEGER,requester_session_id/TEXT,project_id/INTEGER,requested_surface/TEXT,requested_machine_id/TEXT,requested_model/TEXT,presentation_preference/TEXT,allow_surface_fallback/INTEGER,message_id/TEXT,idempotency_key/TEXT,state/TEXT,assigned_relay_id/TEXT,assigned_machine_id/TEXT,native_session_id/TEXT,attestation_hash/TEXT,attestation_consumed_at/TEXT,registered_session_id/TEXT,deadline_at/TEXT,created_at/TEXT,assigned_at/TEXT,launching_at/TEXT,awaiting_registration_at/TEXT,completed_at/TEXT,result_code/TEXT,result_evidence/TEXT"
    ...
    "|session_relays:relay_id/TEXT,actor_id/INTEGER,machine_id/TEXT,hostname/TEXT,relay_version/TEXT,surface_versions/TEXT,project_checkouts/TEXT,first_seen_at/TEXT,last_seen_at/TEXT,connected_until/TEXT,last_job_at/TEXT,state/TEXT,lease_id/TEXT,lease_expires_at/TEXT"
