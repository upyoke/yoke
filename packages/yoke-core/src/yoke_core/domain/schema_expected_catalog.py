...
_EXPECTED_SCHEMA_STR = (
    ...
    "|session_relays:relay_id/TEXT,actor_id/INTEGER,machine_id/TEXT,hostname/TEXT,relay_version/TEXT,surface_versions/TEXT,project_checkouts/TEXT,first_seen_at/TEXT,last_seen_at/TEXT,connected_until/TEXT,last_job_at/TEXT,state/TEXT,lease_id/TEXT,lease_expires_at/TEXT,surface_plan_limits/TEXT,machine_capacity/TEXT,preferred_session_models/TEXT,relay_health/TEXT"
