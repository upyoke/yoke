...
_EXPECTED_SCHEMA_STR = (
    ...
    "|harness_machine_reports:project_id/INTEGER,harness_id/TEXT,glue_written/INTEGER,glue_present/INTEGER,glue_malformed/INTEGER,config_present/INTEGER,project_entry_present/INTEGER,approval_state/TEXT,unattended_posture/TEXT,reported_at/TEXT"
