...
to cancel items past review, releases the item's own worktree lanes as
part of the same terminal close, reconciles `item_dependencies` rows,
writes the status + resolution payload, and posts the GitHub close +
status comment.
"""
