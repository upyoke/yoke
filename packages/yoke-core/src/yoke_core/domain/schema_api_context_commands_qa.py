...
QA_COMMANDS: list[dict] = [
    ...
    },
    {
        ...
        "notes": (
            ...
            "including a direct run-attached row; a run-and-member-bound case "
            "also gets `DEPLOYMENT_RUN_ID` and `DEPLOYMENT_MEMBER_REF`, so it "
            "names its subject, never a literal. `method_config.command` "
