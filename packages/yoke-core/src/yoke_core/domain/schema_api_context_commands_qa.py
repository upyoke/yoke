...
QA_COMMANDS: list[dict] = [
    ...
    },
    {
        ...
        "notes": (
            ...
            "(required for undetermined), execution_status (capture outcome), "
            "and raw_result (result payload). "
    ...
    },
    {
        ...
        "notes": (
            ...
            "agent undetermined creates human "
    ...
    },
    {
        ...
        "notes": (
            ...
            "browser-inspection records an undetermined verdict with the "
            "required reason and creates a review request. Item-backed cases "
