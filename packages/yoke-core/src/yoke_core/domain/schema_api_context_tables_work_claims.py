...
WORK_CLAIM_TABLES: dict[str, dict] = {
    "work_claims": {
        ...
        "notes": (
            ...
            "the session goes quiet. After reviewing the live row, recovery "
            "uses the signed-in human registered action outside any harness "
            ...
            "refuses a changed claim or holder. "
