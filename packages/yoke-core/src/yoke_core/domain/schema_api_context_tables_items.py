...
ITEMS_TABLE: dict[str, dict] = {
    "items": {
        ...
        "notes": (
            ...
            "Current item rows carry `items.workflow_id`; older deployment-run "
            "validation schemas can omit it. Wrong guess: selecting "
            "`items.workflow_id` unconditionally is safe. Probe the column "
