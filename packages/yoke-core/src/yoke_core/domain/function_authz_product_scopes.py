...
PRODUCT_AUTHZ_BY_ID = {
    ...
    "profile.get": AuthzSpec(ACTOR_SESSION, None),
    "profile.token.create": AuthzSpec(ACTOR_SESSION, None),
    ...
    "ui_preferences.search_history.list": AuthzSpec(ACTOR_SESSION, None),
    "ui_preferences.search_history.record": AuthzSpec(ACTOR_SESSION, None),
    ...
    "deployment_runs.execution.attach_driver": AuthzSpec(
        PROJECT, PERM_PROJECT_ADMIN
    ),
    "deployment_runs.execution.release_driver": AuthzSpec(
        PROJECT, PERM_PROJECT_ADMIN
    ),
    ...
    "test_machine.reset": AuthzSpec(PROJECT, PERM_PROJECT_ADMIN),
    "test_machine.golden_capture": AuthzSpec(PROJECT, PERM_PROJECT_ADMIN),
    "test_machine.bridge_diagnose": AuthzSpec(PROJECT, PERM_PROJECT_ADMIN),
