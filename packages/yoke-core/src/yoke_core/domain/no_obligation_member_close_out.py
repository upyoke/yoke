...
def close_out_satisfied_delivery_member(
    ...
    *,
    ...
    ``continue_run=False`` is the run's own settlement closing its members:
    that caller finishes the run itself once every member has closed.
    """
