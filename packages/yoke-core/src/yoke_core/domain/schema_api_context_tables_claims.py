...
CLAIMS_TABLES: dict[str, dict] = {
    "harness_sessions": {
        ...
        "notes": (
            ...
            "alone, so a filing or steering session never reads as working "
            "the item. "
            ...
            "stamp leaves parked. Tool-call telemetry does not unpark. "
            "A stale guess that any later tool call clears parked is wrong. "
            ...
            "because an actor-less session cannot register a path claim. "
            "Legacy "
