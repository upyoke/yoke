...
_SELECT = (
    ...
    "s.background_waiter_id, s.background_waiter_kind, "
    "s.background_waiter_fact, s.background_waiter_armed_at, "
    "s.background_waiter_expected_by, s.background_waiter_completed_at, "
