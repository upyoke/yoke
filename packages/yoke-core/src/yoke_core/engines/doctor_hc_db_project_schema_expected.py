...
_EXPECTED_SCHEMA_STR = (
    ...
    "|coordination_leases:id/INTEGER,project_id/INTEGER,lease_key/TEXT,session_id/TEXT,actor_id/TEXT,acquired_at/TEXT,heartbeat_at/TEXT,released_at/TEXT,release_reason/TEXT"
    ...
    "|deployment_flows:id/TEXT,project_id/INTEGER,name/TEXT,description/TEXT,stages/TEXT,on_failure/TEXT,created_at/TEXT,target_env/TEXT,done_description/TEXT,status/TEXT"
    ...
    "|deployment_runs:id/TEXT,project_id/INTEGER,flow/TEXT,target_env/TEXT,release_lineage/TEXT,status/TEXT,current_stage/TEXT,created_at/TEXT,started_at/TEXT,completed_at/TEXT,created_by/TEXT"
    "|environments:id/TEXT,site/TEXT,name/TEXT,url/TEXT,deploy_method/TEXT,deploy_command/TEXT,health_check_url/TEXT,config_notes/TEXT,last_deployed_at/TEXT,created_at/TEXT,settings/TEXT"
    ...
    "|organizations:id/INTEGER,slug/TEXT,name/TEXT,created_at/TEXT,auto_join_domain/TEXT"
    "|ouroboros_entries:id/INTEGER,timestamp/TEXT,agent/TEXT,context/TEXT,category/TEXT,body/TEXT,reviewed_at/TEXT,archived_at/TEXT,created_at/TEXT,project_id/INTEGER"
    "|ouroboros_entry_corrections:correction_entry_id/INTEGER,corrected_entry_id/INTEGER,created_at/TEXT"
    "|ouroboros_entry_dispositions:entry_id/INTEGER,disposition_kind/TEXT,state/TEXT,item_id/INTEGER,title/TEXT,instruction/TEXT,requested_by_actor_id/INTEGER,requested_by_session_id/TEXT,failure_reason/TEXT,created_at/TEXT,updated_at/TEXT"
    ...
    "|qa_methods:id/TEXT,name/TEXT,description/TEXT,source_kind/TEXT,source_ref/TEXT,project_id/INTEGER,executor_id/TEXT,required_capability_kind/TEXT,verdict_path/TEXT,verdict_contract/TEXT,evidence_contract/TEXT,success_policy_id/TEXT,success_policy_params/TEXT,concurrency_mode/TEXT,created_at/TEXT,updated_at/TEXT,display_icon/TEXT,display_order/INTEGER,display_group/TEXT,config_contract_id/TEXT,proof_kind/TEXT,executor_gloss/TEXT"
    ...
    "|qa_plans:id/INTEGER,project_id/INTEGER,slug/TEXT,name/TEXT,description/TEXT,success_policy_id/TEXT,success_policy_params/TEXT,created_at/TEXT,updated_at/TEXT,retired_at/TEXT,target_environment_id/TEXT"
    "|qa_requirements:id/INTEGER,item_id/INTEGER,epic_id/INTEGER,task_num/INTEGER,deployment_run_id/TEXT,qa_kind/TEXT,qa_phase/TEXT,target_env/TEXT,blocking_mode/TEXT,requirement_source/TEXT,success_policy/TEXT,capability_requirements/TEXT,suite_id/TEXT,waived_at/TEXT,waiver_rationale/TEXT,waiver_source/TEXT,created_at/TEXT,plan_id/INTEGER,plan_case_key/TEXT,case_position/INTEGER,baseline_position/INTEGER,method_id/TEXT,method_name/TEXT,executor_id/TEXT,required_capability_kind/TEXT,verdict_path/TEXT,host_baseline/TEXT,entry_surface/TEXT,required_completion/TEXT,workflow_transition_id/TEXT,instructions/TEXT,expected_outcome/TEXT,method_config/TEXT,execution_target_json/TEXT,execution_target_digest/TEXT"
    "|qa_runs:id/INTEGER,qa_requirement_id/INTEGER,executor_type/TEXT,qa_kind/TEXT,verdict/TEXT,execution_status/TEXT,score/REAL,confidence/REAL,raw_result/TEXT,duration_ms/INTEGER,started_at/TEXT,completed_at/TEXT,created_at/TEXT,case_outcome/TEXT,capture_degraded_reason/TEXT"
    ...
    "|strategy_doc_claims:id/INTEGER,project_id/INTEGER,strategy_doc_slug/TEXT,owning_item_id/INTEGER,registered_by_actor_id/INTEGER,registered_by_session_id/TEXT,registered_at/TEXT,released_by_actor_id/INTEGER,released_by_session_id/TEXT,released_at/TEXT,release_mode/TEXT,release_reason/TEXT"
    ...
    "|workflow_versions:id/INTEGER,workflow_id/TEXT,version/INTEGER,definition_schema_version/INTEGER,definition_json/TEXT,definition_digest/TEXT,published_at/TEXT,published_by_actor_id/INTEGER,immutable_at/TEXT"
