...
_EXPECTED_SCHEMA_STR = (
    ...
    "|deployment_flows:id/TEXT,project_id/INTEGER,name/TEXT,description/TEXT,stages/TEXT,on_failure/TEXT,created_at/TEXT,target_tier/TEXT,target_environment_id/TEXT,done_description/TEXT,status/TEXT"
    ...
    "|deployment_runs:id/TEXT,project_id/INTEGER,flow/TEXT,target_tier/TEXT,target_environment_id/TEXT,release_lineage/TEXT,status/TEXT,current_stage/TEXT,created_at/TEXT,started_at/TEXT,completed_at/TEXT,created_by/TEXT"
