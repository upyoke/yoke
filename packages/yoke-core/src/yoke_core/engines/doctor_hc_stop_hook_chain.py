"""HC-stop-hook-chain-end-deferred: stranded Stop deferrals and chain membership.
...
must keep the promised-work gate ahead of lifecycle dispatch.
"""
...
_MEMBER_DESC = "Stop chain registers the work gate before lifecycle dispatch"
_EXPECTED_STOP = [
