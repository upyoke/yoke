...
INSTALLER_ADAPTERS: List[AdapterEntry] = [
    ...
    _read_entry(function_id="packs.catalog.list", cli_invocation="yoke packs list --project NAME [--json]", notes="Shows available, installed, and stale Packs from the shipped catalog plus the project's last repository report."),
