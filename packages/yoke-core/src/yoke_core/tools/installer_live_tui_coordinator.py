...
def _project_apply_seed_resume_report_command(*, api_url: str, path: str) -> str:
    script = (
        ...
        "  'token_sources':{'yoke':{'kind':'file','path':'/tmp/yoke-fake-api.token'},'machine_github':{'kind':'','path':''},'project_github':{'kind':'','path':''}},\n"
        "  'input_snapshot':{\n"
        "    'config_path':config_path,\n"
        "    'env_name':'stage',\n"
        "    'api_url':api_url,\n"
