...
WRAPPED_ROWS: Tuple[_Row, ...] = (
    ...
    _w("yoke claims steering-scope acquire", "claims.steering_scope"),
    _w("yoke claims steering-scope release", "claims.steering_scope"),
    _w("yoke claims steering-scope list", "claims.steering_scope"),
