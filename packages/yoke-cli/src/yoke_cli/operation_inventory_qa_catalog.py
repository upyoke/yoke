...
WRAPPED_ROWS: tuple[_Row, ...] = (
    ...
    _w("yoke qa registered-command set", "qa.registered_command"),
    _w("yoke qa no-tests attest", "qa.no_tests"),
    _w("yoke qa no-tests clear", "qa.no_tests"),
    ...
    _w("yoke qa item-plan retract", "qa.item_plan"),
