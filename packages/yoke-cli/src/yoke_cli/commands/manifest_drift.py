...
def manifest_unknown_hint(
    ...
    *,
    ...
    try:
        running_version, running_module_file = _running_identity()
        layer_recovery = _installed_layer_recovery(
            running_version,
            running_module_file,
        )
    except Exception:
...
def _running_identity() -> tuple[str, str]:
    import yoke_cli
...
def _installed_layer_recovery(
    running_version: str,
    running_module_file: str,
) -> str:
    """Name the refresh when project teaching predates running code."""
