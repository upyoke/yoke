...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "sessions, wait for their registration, and re-preview. A retry of "
            "an unconsumed run id starts a new preparation attempt rather than "
            "colliding with a prior key. The branch the "
