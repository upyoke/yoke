...
from yoke_cli.commands.browser_authorize import (
    TOOL_SHAPED_SUBCOMMANDS as _BROWSER_AUTHORIZE_SUBCOMMANDS,
    TOOL_SHAPED_USAGE as _BROWSER_AUTHORIZE_USAGE,
)
...
from yoke_cli.commands.claude_status_line import (
    TOOL_SHAPED_SUBCOMMANDS as _CLAUDE_STATUS_LINE_SUBCOMMANDS,
    TOOL_SHAPED_USAGE as _CLAUDE_STATUS_LINE_USAGE,
)
from yoke_cli.commands.codex_hook_trust import (
    TOOL_SHAPED_SUBCOMMANDS as _CODEX_HOOK_TRUST_SUBCOMMANDS,
    TOOL_SHAPED_USAGE as _CODEX_HOOK_TRUST_USAGE,
)
...
from yoke_cli.commands.hook_latency_benchmark import (
    TOOL_SHAPED_SUBCOMMANDS as _HOOK_BENCHMARK_SUBCOMMANDS,
    TOOL_SHAPED_USAGE as _HOOK_BENCHMARK_USAGE,
)
...
TOOL_SHAPED_SUBCOMMANDS: Dict[Tuple[str, ...], AdapterFn] = {
    ...
    **_BROWSER_AUTHORIZE_SUBCOMMANDS,
    **_CHECK_SUBCOMMANDS,
    **_CLAUDE_STATUS_LINE_SUBCOMMANDS,
    **_CODEX_HOOK_TRUST_SUBCOMMANDS,
...
TOOL_SHAPED_USAGE: Dict[str, str] = {
    ...
    **_BROWSER_AUTHORIZE_USAGE,
    **_CHECK_USAGE,
    **_CLAUDE_STATUS_LINE_USAGE,
    **_CODEX_HOOK_TRUST_USAGE,
    **_CONNECT_USAGE,
