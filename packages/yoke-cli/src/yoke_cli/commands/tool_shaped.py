...
from yoke_cli.commands.coordination_lease import (
    TOOL_SHAPED_SUBCOMMANDS as _COORDINATION_LEASE_SUBCOMMANDS,
    TOOL_SHAPED_USAGE as _COORDINATION_LEASE_USAGE,
)
...
TOOL_SHAPED_SUBCOMMANDS: Dict[Tuple[str, ...], AdapterFn] = {
    ...
    **_COORDINATION_LEASE_SUBCOMMANDS,
