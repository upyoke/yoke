...
_Audit generated_at: 2026-09-04T03:55:07Z_

## 1. Summary

- Function ids registered: **457**
- Internal dispatch-only functions without CLI adapters: **90**
- `yoke` CLI subcommands: **384** (384 carry usable `--help`)
- Operation tracker: **360 wrapped**, 14 tool_cli, 137 permanent, 0 pending
...
Wrapped dispatcher-backed `yoke <subcommand>` adapters: **360** (operation tracker confirms 360 wrapped rows).
...
| claims | `yoke claims coordination-claim acquire` | `claims.coordination_claim.acquire` | ok |
...
| claims | `yoke claims coordination-claim release` | `claims.coordination_claim.release` | ok |
...
| decision_requests | `yoke decision-requests dispose-ended` | `decision_requests.dispose_ended` | ok |
...
| browser.profile | `yoke browser authorize` | tool_shaped | — |
...
| project | `yoke project git bootstrap` | tool_shaped | — |
...
| qa.mission | `yoke qa mission scratch-teardown` | tool_shaped | — |
...
| self_host.teardown | `yoke self-host teardown` | tool_shaped | — |
