"""Test-fixture runtime/event/deployment/registry Postgres DDL."""
...
CREATE TABLE IF NOT EXISTS project_capabilities (
    ...
    verified_at TEXT, created_at TEXT NOT NULL DEFAULT '1970-01-01T00:00:00Z', settings TEXT DEFAULT '{}',
...
CREATE TABLE IF NOT EXISTS deployment_flows (
    ...
    status TEXT NOT NULL DEFAULT 'active', definition_schema_version INTEGER NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS deployment_runs (
    ...
    candidate_containment TEXT, artifact_identity TEXT,
    composition_resolution TEXT,
    composition_frozen_at TEXT,
    requirement_snapshot TEXT, driver_attachment TEXT, settling_at TEXT,
    CHECK((target_tier IS NOT NULL AND target_tier = 'persistent')
          = (target_environment_id IS NOT NULL))
);
...
CREATE INDEX IF NOT EXISTS idx_path_claims_owner_kind ON path_claims(owner_kind);
CREATE INDEX IF NOT EXISTS idx_path_claims_owner_item ON path_claims(owner_item_id);
CREATE INDEX IF NOT EXISTS idx_path_claims_owner_session ON path_claims(owner_session_id);
CREATE INDEX IF NOT EXISTS idx_path_claims_owner_work_claim ON path_claims(owner_work_claim_id);
