...
def test_friendly_line_covers_full_action_vocabulary() -> None:
    ...
    cases = {
        ...
        ("project-install-scaffold", ""): "Install the Yoke project scaffold (.yoke/)",
        ("project-refresh-scaffold", ""): "Refresh the Yoke project scaffold (.yoke/)",
        (
