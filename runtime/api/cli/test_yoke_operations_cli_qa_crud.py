...
class TestQaRequirementAdd:
    ...
    def test_missing_workflow_transition_returns_two(self) -> None:
        rc = _run(
            _stub_ok,
            "qa",
            "requirement",
    ...
    def test_dispatches_workflow_transition_binding(self) -> None:
        ...
        assert rc == 0
        assert (
            _CAPTURED_REQUESTS[-1].payload["workflow_transition_id"]
            == "reviewing-implementation"
        )
...
class TestQaRequirementAddBatch:
    ...
    def test_row_without_workflow_transition_returns_two(self) -> None:
