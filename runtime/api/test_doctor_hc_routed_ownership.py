...
from runtime.api.test_doctor_hc_routed_ownership_helpers import (
    _insert_item,
...
pytest_plugins = ("runtime.api.test_doctor_hc_routed_ownership_helpers",)
...
class TestLiveFrameNoDefense:
    ...
    def test_warn_when_defense_window_expired(self, conn) -> None:
        ...
        assert "yoke claims work acquire --item YOK-N" in result.detail
        assert "yoke claims work holder-get YOK-N" in result.detail
