...
def test_report_renders_cursor_pools_as_distinct_meter_rows(test_db) -> None:
                    ...
                    "cursor-cli": {
                        ...
                        "windows": [
                            ...
                            },
                            {
                                "window_kind": "monthly",
                                "scope": "Other Models",
                                "meter": "planUsage.apiPercentUsed",
    ...
    assert "planUsage.autoPercentUsed | monthly · Cursor Models | 0%" in body
    assert "planUsage.apiPercentUsed | monthly · Other Models | 90%" in body
