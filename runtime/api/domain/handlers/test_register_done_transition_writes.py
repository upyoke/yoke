"""Registration wiring for the internal done-transition finalize writes.
...
def test_done_transition_write_is_internal_session_optional(function_id) -> None:
    ...
    assert entry.side_effects == _DONE_TRANSITION_WRITES[function_id]
