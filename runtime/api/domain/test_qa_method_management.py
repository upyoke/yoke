...
def test_project_method_uses_registered_runner_contract() -> None:
...
def test_project_method_rejects_unregistered_runner() -> None:
    with test_database() as conn:
        with pytest.raises(QaMethodError, match="not registered"):
            register_project_method(
                ...
                description="An unsupported runner.",
                runner_id="shell_anything",
                verdict_path="automatic",
