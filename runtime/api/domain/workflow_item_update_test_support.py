...
def add_epic_task(conn, epic_id, task_num, title, **kwargs):
    ...
    if (
        ...
        # Recording a worker lane may mint the integration lane branch,
        # named from the epic's public reference, so the epic needs a
        # sequence — deliberately not its internal id.
        conn.execute(
            "INSERT INTO items "
