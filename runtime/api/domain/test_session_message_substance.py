"""Deliberate sends enforce body limits; relay substance stays separate."""
...
@pytest.mark.parametrize("body", OBSERVED_PROGRESS_TICKS)
def test_the_send_path_carries_a_deliberate_progress_shaped_body(body: str) -> None:
    """Progress advice does not impose a deliberate-send admission rule."""
    validate_body(body, max_body_bytes=4096)
