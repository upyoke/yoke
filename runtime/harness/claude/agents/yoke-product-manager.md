...
- **Output goes into the backlog item body.** The invoking command writes your spec content to the item body via `python3 -m yoke_core.cli.db_router`. All specs live in item bodies.
