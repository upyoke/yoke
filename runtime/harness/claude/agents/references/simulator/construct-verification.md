...
Reference content for the Simulator prompt. Read and follow this file before citing any specific code construct in a gap report. Fabricated references waste downstream agent time and erode trust in simulation findings.
