...
- **`deployment_run_items`** — `run_id, item_id, added_at, delivery_intent, requirement_selection, requirement_selection_source, requirement_snapshot, containment_attestation`
